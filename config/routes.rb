Rails.application.routes.draw do
  ...
  resources :secubat_clients do
    member do
      put :send_mailing_model
    end
    collection do
      post :send_mailings_model
    end
  end
  resources :urls
  resources :statuses
  ...
  resources :todos do
    member do
      post :update_status, :update_type, :update_difficulty, :update_emergency, :update_importance
    end
    collection do
      get 'search'
    end
